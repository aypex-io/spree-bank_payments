  ...
  module BankTransfer
    module Generators
      class InstallGenerator < Rails::Generators::Base
        desc 'Copies Spree::BankTransfer migrations into the host application and runs them.'
        ...
        def copy_migrations
          # Scoped to this engine only: sets ENV["FROM"] = "spree_bank_transfer" before
          ...
          rake 'spree_bank_transfer:install:migrations'
        end
