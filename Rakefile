...
task :test_app do
  ...
  # -- which only resolves to Spree::BankTransfer::Generators::InstallGenerator when
  # this is the slash form.
  ENV['LIB_NAME'] = 'spree/bank_transfer'
  ...
  # schema, then auto-loads generators/spree/bank_transfer/install/install_generator
